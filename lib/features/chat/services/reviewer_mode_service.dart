...
class ReviewerModeService {
  ...
  static const Map<String, List<String>> _cannedResponses = {
    'greeting': [
      'Hello! I\'m here to help you explore Clinical Guidelines\'s features. What would you like to know?',
      'Hi there! Welcome to Clinical Guidelines. How can I assist you today?',
      'Greetings! I\'m ready to help you test out Clinical Guidelines\'s chat capabilities.',
    ],
    'code': [
      'Here\'s a simple example of what I can help with:\n\n```python\ndef greet(name):\n    return f"Hello, {name}!"\n\nprint(greet("Clinical Guidelines User"))\n```\n\nI can assist with various programming languages and tasks.',
    ...
    'general': [
      'That\'s an interesting question! Let me think about "{query}".\n\nIn Clinical Guidelines, you can explore various topics and get detailed responses. The app is designed to be your AI companion for learning, creating, and problem-solving.\n\n(Demo Mode: These are sample responses for app review)',
      'Regarding "{query}", here\'s what I can share:\n\nClinical Guidelines provides a seamless chat experience with advanced AI capabilities. Whether you\'re looking for information, creative assistance, or technical help, I\'m here to support you.\n\nNote: This is a demo response - actual usage requires your own AI server.',
    ...
    'error': [
      'I noticed there might be an issue. In a production environment, Clinical Guidelines handles errors gracefully and provides helpful feedback. This demo mode simulates that experience.\n\nPlease try your request again, or let me know how I can help differently!',
      'It seems something unexpected happened. Clinical Guidelines is designed to recover smoothly from errors and continue providing assistance.\n\nWould you like to try a different query or explore another feature?',
    ],
  };
